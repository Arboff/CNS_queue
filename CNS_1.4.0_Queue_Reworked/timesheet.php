...
<div class="section">
    ...
    <div style="display:flex; align-items:flex-start; gap:20px; flex-wrap:wrap; margin-top:10px;">
        <div class="flex-row" style="flex-wrap:wrap; gap:10px;">
            <button onclick="window.location.href='graphs.php'">Graph View</button>
            <button onclick="window.location.href='broadcast.php'">Broadcast Message</button>
            <button onclick="window.location.href='breaks.php'">Breaks Manager</button>
            <button onclick="window.location.href='feedback.php'">Feedback Submission</button>
        </div>
        <div style="flex:1; color:#666; font-style:italic; min-width:200px;">
...
<div class="section">
    <h2>Older Revisions</h2>
    <div style="display:flex; align-items:flex-start; gap:20px; flex-wrap:wrap; margin-top:10px;">
        <div class="flex-row" style="flex-wrap:wrap; gap:10px;">
            <button onclick="window.location.href='1.1/index.php'">1.1</button>
            <button onclick="window.location.href='1.2/index.php'">1.2</button>
            <button onclick="window.location.href='1.3/index.php'">1.3</button>
            <button onclick="window.location.href='index.php'">1.4 (CURRENT)</button>
            <button onclick="showExperimentalAlert()">Experimental</button>
        </div>
        <div style="flex:1; color:#666; font-style:italic; min-width:200px;">
...
<script>
function showExperimentalAlert() {
    alert("Experimental Builds are still WIP. No Builds have been submitted, or backend has been configured for them.");
}
</script>
