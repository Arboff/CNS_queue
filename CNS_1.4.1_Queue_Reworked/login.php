        ...
        foreach($users as $storedUser => $info) {
            if (strcasecmp($storedUser, $inputUser) === 0) { 
                ...
                if ($info['password'] === $inputPass) {
                    ...
                    // --- Hard session expiration after login ---
                    $_SESSION['login_time'] = time();       // timestamp of login
                    $_SESSION['expire_after'] = 43200;         // seconds (set 15 for testing)
...
// Check for session expiration redirect message
...
<body>
    ...
    <div class="page-footer">
        Version 1.4.2 | Build: 2025-09-06
    </div>
</body>
</html>
